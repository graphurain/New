const SPREADSHEET_ID = "1wHxDZgXtk3PLJgBCW66CgEZ-rkxhha827661r7s5Vro";
...
function sendConfirmationEmail(formData) {
  try {
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p>Thank you for your interest in joining Graphura team</p>
        </div>
        ...
        <div class="content">
          ...
          <div class="info-box">
            ...
            <div class="info-row">
              ...
              <span class="info-value"><span class="badge">${formData.domain}</span></span>
            </div>
            <div class="info-row">
    ...
    Application Summary:
    - Position Applied: ${formData.domain}
